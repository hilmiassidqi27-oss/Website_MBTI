...
const customDatabaseId = import.meta.env.VITE_FIREBASE_DATABASE_ID || rawConfig.firestoreDatabaseId || rawConfig.databaseId || undefined;
...
// If a specific non-default database ID is specified, use it. Otherwise use the standard default database.
